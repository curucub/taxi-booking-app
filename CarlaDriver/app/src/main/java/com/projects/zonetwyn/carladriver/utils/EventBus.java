...
public class EventBus {
    ...
    public static final int SUBJECT_SIGN_IN = 0;
    public static final int SUBJECT_SIGN_UP = 1;
    public static final int SUBJECT_DASHBOARD = 2;
    public static final int SUBJECT_MAIN = 3;

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({SUBJECT_SIGN_IN, SUBJECT_SIGN_UP, SUBJECT_DASHBOARD, SUBJECT_MAIN})
    @interface Subject {
    }
